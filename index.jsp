...
<%
rs=st.executeQuery("  SELECT * FROM product INNER JOIN product_category ON product.category_ID = product_category.category_ID ;");
...
rs=st.executeQuery("SELECT * FROM product INNER JOIN product_category ON product.category_ID = product_category.category_ID where name_category='MACHIN'; ");
...
rs=st.executeQuery(" SELECT * FROM product INNER JOIN product_category ON product.category_ID = product_category.category_ID where name_category='TV';");
...
<div class="product-body">
<p class="product-sumsong"><%=rs.getString(11) %></p>
<label class="hidden"><%=rs.getString(8) %></label>
<h3 class="product-name"><a href="storemachin.jsp"> <%=rs.getString(1) %></a></h3>
