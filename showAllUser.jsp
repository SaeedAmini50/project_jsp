                            ...
                            <table class="table">
                                <thead>
                                 <tr>
                                        ...
                                        <th scope="col">سوال امنیتی</th>
                                        <th scope="col">جواب امنیتی</th>
...
while(rs.next()){%>
                                    ...
                                    <th> Edit <i class="fas fa-pen-fancy"></i></th>
                                        ...
                                        <td name="name"> <%=rs.getString(3) %></td>
                                        <td name="Last name"><%=rs.getString(4) %></td>
                                        <td name="email"><%=rs.getString(2) %></td>
                                          <td name="question"><%=rs.getString(5) %></td>
                                        <td name="answer"><%=rs.getString(6) %></td>
                                        <td name="password"><%=rs.getString(7)  %></td>
