...
ResultSet rs=st.executeQuery("select * from product where product_name  like '%"+search+"%' or category_ID like '%"+search+"%' or product_mark like '%"+search+"%' or product_attribute like '%"+search+"%' and product_active='yes';");
